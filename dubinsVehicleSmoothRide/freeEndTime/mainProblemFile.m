...
xL=-30;  yL=-30;  thetaL=-2*pi;
xU=30;   yU=30;   thetaU=2*pi;
...
%set the bounds for the initial and final time.  Since the final time is free, we give a
%large bound for the final time
t0 = 0;  tfMax = 15;
